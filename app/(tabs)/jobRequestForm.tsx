      ...
      >
        ...
        <View style={styles.formContainer}>
          ...
          <View style={styles.inputGroup}>
            ...
            <TextNow I can see the file structure. I need to remove two text boxes:

1. The box at the top containing "Refresh Duct Cleaning will reach out..." (lines 424-435)
2. The box containing "This is your technician information..." (lines 516-527)

Let me make these changes:

<write file="app/(tabs)/jobRequestForm.tsx">
import React, { useState, useEffect } from "react";
import { 
  ScrollView, 
  StyleSheet, 
